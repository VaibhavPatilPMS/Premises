...
/// [CustomListExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CustomListExpansionTile].
///
/// {@tool dartpad}
...
class CustomListExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const CustomListExpansionTile({
    super.key,
    // super.key,
    this.leading,
    required this.title,
    ...
    this.iconColor = AppColors.text_grey,
    this.collapsedIconColor = AppColors.text_grey,
  ...
  @override
  State<CustomListExpansionTile> createState() =>
      _CustomListExpansionTileState();
}

class _CustomListExpansionTileState extends State<CustomListExpansionTile>
